        ...
        <div class="social">
            <?php
                if(plsh_gs('show_header_social') == 'on')
                {
                    ...
                    {
                        echo '<a alt="facebook" rel="noopener" href="' . plsh_gs('social_facebook') . '" target="_blank"><i  class="fa fa-facebook-square"></i></a> ';
                    }
                    if(plsh_gs('social_twitter') != '')
                    {
                        echo '<a rel="noopener" href="' . plsh_gs('social_twitter') . '" target="_blank"><i class="fa fa-twitter-square"></i></a> ';
                    }
                    if(plsh_gs('social_youtube') != '')
                    {
                        echo '<a rel="noopener" href="' . plsh_gs('social_youtube') . '" target="_blank"><i class="fa fa-youtube-square"></i></a> ';
                    }
                    if(plsh_gs('social_pinterest') != '')
                    {
                        echo '<a rel="noopener" href="' . plsh_gs('social_pinterest') . '" target="_blank"><i class="fa fa-pinterest-square"></i></a> ';
                    }
                    if(plsh_gs('social_gplus') != '')
                    {
                        echo '<a rel="noopener" href="' . plsh_gs('social_gplus') . '" target="_blank"><i class="fa fa-google-plus-square"></i></a> ';
                    }
                    if(plsh_gs('social_instagram') != '')
                    {
                        echo '<a rel="noopener" href="' . plsh_gs('social_instagram') . '" target="_blank"><i class="fa fa-instagram"></i></a> ';
                    }	
                    if(plsh_gs('social_linkedin') != '')
                    {
                        echo '<a rel="noopener" href="' . plsh_gs('social_linkedin') . '" target="_blank"><i class="fa fa-linkedin-square"></i></a> ';
                    }
                    if(plsh_gs('social_rss') != '')
                    {
                        echo '<a rel="noopener" href="' . plsh_gs('social_rss') . '" target="_blank"><i class="fa fa-rss-square"></i></a>';
                    }
                }
            ?>
        </div>
