...
<div class="container homepage-content hfeed thumb-<?php echo esc_attr($post_image_width); ?>">
    ...
    <div class="main-content-column-1 <?php if(plsh_gs('sidebar_position') === 'left') { echo ' right'; } else { echo ' left'; } ?>">
        ...
        <!-- Post -->
        <div <?php post_class($class); ?> itemscope itemtype="http://schema.org/<?php if(plsh_is_review()) { echo 'Review'; } else { echo 'NewsArticle'; } ?>">
            ...
            <span class="item-summary-hidden" itemprop="description"><?php echo plsh_excerpt(25); ?></span>
            <?php if($thumb) { ?> <img class="item-image-hidden" itemprop="image" src="<?php echo esc_url($thumb); ?>" alt="<?php esc_attr(the_title()); ?>" /> <?php } ?>

            <div class="post" <?php if(plsh_is_review()) { echo ' itemprop="description"'; } else { echo ' itemprop="articleBody"'; } ?>><?php echo $post->post_content; ?></div>
